...
public class DatapackUtil {
    ...
    private static void generatePackMcmeta() throws IOException {
        ...
        JsonObject packMcmeta = new JsonParser().parse(String.format(
                "{\"pack\":{\"pack_format\":%d,\"description\":\"%s\"}}",
    ...
    private static void generateRootAdvancement() throws IOException {
        ...
        JsonObject rootAdvancement = new JsonParser().parse("{\"criteria\":{\"tick\":{\"trigger\":\"minecraft:tick\"}}}").getAsJsonObject();
    ...
    private static void generateRuleAdvancement(Path dataPath, String ruleName, String[] recipes) {
        try {
            ...
            JsonObject ruleAdvancement = new JsonParser().parse("{\"criteria\":{\"tick\":{\"trigger\":\"minecraft:tick\"}},\"rewards\":{\"recipes\":[]}}").getAsJsonObject();
